  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <section className="mt-10">
        ...
        <p className="mt-4 rounded-lg border border-white/10 bg-black/20 p-5 text-sm leading-7 text-white/75">It is not a combat game: the focus is the farm tycoon loop and growing it over time. One thing that surprises new players: hired workers keep cutting grass even while you're offline, so workers are an always-on income layer, not just active-session helpers. Learn the full loop in the <Link href="/en/how-to-play" className="font-semibold text-[color:var(--accent)] hover:underline">how-to-play guide</Link>, and grab the <Link href="/en/codes" className="font-semibold text-[color:var(--accent)] hover:underline">RELEASE and MERCHANT codes</Link> to start with a boost. As a recent game (released 23 July 2026) it changes fast, and this wiki updates as changes are confirmed rather than guessing patch notes.</p>
      </section>
